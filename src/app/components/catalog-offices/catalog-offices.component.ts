...
export class CatalogOfficesComponent implements OnInit {
  offices: object = [
    {name: 'office 1', phoneNumber: 11111111, direction: 'Av 1 no 01, zip code 11111'},
    {name: 'office 2', phoneNumber: 22222222, direction: 'Av 2 no 02, zip code 22222'},
    {name: 'office 3', phoneNumber: 33333333, direction: 'Av 3 no 03, zip code 22222'}
  ];
